...
export default function ListData({navigation}) {
  ...
  messaging().onMessage(async remoteMessage => {
    ...
    getData('user').then(res => {
      ...
      axios
        .post('https://zavalabs.com/petadampot/api/transaksi.php', {
          id_member: res.id,
        })
        .then(res => {
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      onPress={() => {
                        axios
                          .post(
                            'https://zavalabs.com/petadampot/api/transaksi_hapus.php',
                            {
                              id: item.id,
                            },
                          )
                          .then(res => {
                            axios
                              .post(
                                'https://zavalabs.com/petadampot/api/transaksi.php',
                              )
                              .then(res => {
                                console.log(res.data);
                                setData(res.data);
